...
public class DatabaseSeeder implements CommandLineRunner {
    ...
    public void run(String... args) {
        if (userRepository.count() == 0) {
            ...
            User user3 = new User("johny2", passwordEncoder.encode("Password123!"), "Test1", "Test1", "test1@example.com", AccountStatus.ACTIVE);
            User user4 = new User("johny3", passwordEncoder.encode("Password123!"), "Test2", "Test2", "test2@example.com", AccountStatus.ACTIVE);
            User user5 = new User("johny4", passwordEncoder.encode("Password123!"), "Test3", "Test3", "test3@example.com", AccountStatus.ACTIVE);
